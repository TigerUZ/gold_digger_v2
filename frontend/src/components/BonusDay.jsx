...
function BonusDay({day="Today", value=10, selected = false, active=false}) {

    return (
        <>
            <div className="bonus-day-container">
                <h3>{day}</h3>
                <div className={"bonus-day-text-icon-container" + (active ? "": " not-active")}>
                    <span className={"bonus-day-text" + (selected ? " selected": "")}>{value}</span>
                    <svg width='32px' height='32px' viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
